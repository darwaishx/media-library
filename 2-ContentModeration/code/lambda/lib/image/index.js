...
module.exports.respond = function(event, cb) {
    ...
    else if (event.lambda.function_name == 'get_moderation_labels') {
        _image.getModerationLabels(event, function(err, data) {
            if (err) {
                return cb(err, null);
            }
            else {
    ...
    else if (event.lambda.function_name == 'get_detect_text') {
        _image.getDetectText(event, function(err, data) {
            if (err) {
                return cb(err, null);
            }
            else {
